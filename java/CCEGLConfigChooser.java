...
public class CCEGLConfigChooser implements GLTextureView.EGLConfigChooser {
    ...
    public CCEGLConfigChooser(int redSize, int greenSize, int blueSize, int alphaSize, int depthSize, int stencilSize, int multisamplingCount)
    {
        mConfigAttributes = new int[] {redSize, greenSize, blueSize, alphaSize, depthSize, stencilSize, multisamplingCount};
    }
    public CCEGLConfigChooser(int[] attributes)
    {
    ...
    public EGLConfig chooseConfig(EGL10 egl, EGLDisplay display)
    {
        ...
        Log.e("Cocos2d-x", "Can not select an EGLConfig for rendering.");
        return null;
    }
